...
function CreateRoomCard({ onOpen }: { onOpen: () => void }) {
  return (
    <div style={cardStyles.card}>
      ...
      <p style={cardStyles.subtitle}>新しいゲーム部屋を作成して友達を招待しましょう</p>
      <div style={cardStyles.iconCircle}>
        <span style={cardStyles.plus}>＋</span>
      </div>
      <button style={cardStyles.button} onClick={onOpen}>
        部屋を作成
      </button>
    </div>
  );
      ...
      {showModal && (
        <div style={styles.overlay}>
          <div style={styles.modal}>
            <button style={styles.backButton} onClick={() => setShowModal(false)}>
              &lt; 戻る
            </button>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={styles.formGroup}>
                ...
                <input
                  ...
                  required
                />
                <small>他のプレイヤーが部屋に参加するために必要なあいことばです</small>
              </div>
              <div style={styles.formGroup}>
