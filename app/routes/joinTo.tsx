    ...
    <>
      ...
      >
        ...
        <div style={{ margin: "0 0 28px 0" }}>
          {/* シンプルなアイコン（SVG） */}
          <svg width="96" height="96" viewBox="0 0 96 96" fill="none" style={{ display: "block", margin: "0 auto" }}>
            <circle cx="48" cy="48" r="48" fill="#F6F7F9"/>
            <path d="M48 52c7.732 0 14-6.268 14-14s-6.268-14-14-14-14 6.268-14 14 6.268 14 14 14zm0 4c-9.941 0-30 5.02-30 15v5h60v-5c0-9.98-20.059-15-30-15z" fill="#D1D5DB"/>
          </svg>
        </div>
        <button
